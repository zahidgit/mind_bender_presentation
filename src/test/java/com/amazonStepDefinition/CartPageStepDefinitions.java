...
public class CartPageStepDefinitions {
	...
	AmazonLOginPageAction AmazonLOginPageActionObjecto = new AmazonLOginPageAction();
	AmazonPagetoCartActions action1 = new AmazonPagetoCartActions();
	
			@Given("I am on Amazon home page")
			public void i_am_on_Amazon_home_page() {
				action1.getAmazonLoginPage();
			}
